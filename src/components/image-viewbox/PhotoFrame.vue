  ...
  <div class="photo-frame" @click.stop="resetSelect">
    <Draggable v-model="ImageModelList" v-if="model.length" @change="dragSort" class="photo-frame__container">
      <template v-for="(image, index) in model">
        ...
        >
          <div class="photo-frame__container__item__block" :class="{ 'photo-frame__container__item__block--active': isActive(image) }">
          ...
          <input class="photo-frame__container__item__input" type="file" ref="input" @change="changeFileInput($event, image, index)" />
        </div>
      </template>
    </Draggable>
    <div class="photo-frame__container" v-else>
      <div class="photo-frame__container__item photo-frame__container__item--create" @dragover="dragover" @drop="dropFileInput">
    ...
    <div class="photo-frame__fixed-bar">
      <div class="photo-frame__fixed-bar__plus" v-if="model.length && fileLength > model.length" v-html="plusIcon" @click.stop="clickCreateImage('plus')">
        <input class="photo-frame__container__item__plus__input" type="file" multiple="true" ref="plus" @change="changeFileInput" />
      </div>
